...
export default function OsheCoffee() {
  ...
  // Condition for dark navbar background
        ...
        <>
          ...
          <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
            <div 
              ...
              style={{ 
                backgroundColor: 'rgba(2, 29, 233, 0.05)',
                top: '10%', 
                left: '5%',
            ...
            <div 
              ...
              style={{ 
                backgroundColor: 'rgba(2, 29, 233, 0.07)',
                top: '50%', 
                right: '10%',
                ...
                <div className="hidden md:flex items-center gap-1">
                  {['Home', 'Story', 'Menu', 'Gallery', 'Contact'].map((item) => (
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium transition-colors hover:bg-black/10 rounded-md"
                      style={{ color: navHasDarkBg ? colors.white : colors.darkGreen }}
                    >
                      {item}
                    </button>
                  ))}
                ...
                <div className="px-6 py-6 space-y-1">
                  {['Home', 'Story', 'Menu', 'Gallery', 'Contact'].map((item) => (
                    <button
                      key={item}
                      onClick={() => scrollToSection(item.toLowerCase())}
                      className="block w-full text-left px-4 py-3 text-sm font-medium hover:bg-white/10 rounded-lg transition-all"
          ...
          <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 pb-16 px-4 overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-6xl mx-auto">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <span className="block">Brew Your</span>
              ...
              <div className="flex flex-wrap gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                ...
                <button
                  ...
                  className="px-8 py-3 font-medium text-base rounded-full border-2 transition-all duration-300 hover:shadow-lg hover:scale-105"
                  style={{ borderColor: colors.blue, color: colors.blue, backgroundColor: 'transparent' }}
                >
                  Our Story
                </button>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-6 animate-fade-in-left">
                  <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight">
                    Coffee is
                    <span className="block mt-2" style={{ color: colors.blue }}>
                      not just a drink
                    </span>
                  </h2>
                  ...
                  >
                    ...
                    <div className="relative">
                      <div className="flex justify-between items-start mb-4">
                        <h3 className="text-2xl font-bold group-hover:scale-105 transition-transform origin-left" style={{ color: colors.darkGreen }}>
                          {item.name}
                        </h3>
                      ...
                      <div className="inline-block px-6 py-3 text-white font-bold text-xl rounded-full shadow-lg" style={{ backgroundColor: colors.blue, color: colors.white }}>
                        {item.price}
                      </div>
                    </div>
                  </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((item) => (
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-center group-hover:scale-110 transition-transform duration-500" style={{ backgroundColor: colors.blue }}>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="space-y-8 animate-fade-in-left">
                  {[
                    ...
                    <div key={index} className="flex gap-6 items-start group cursor-pointer">
                      <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300 shadow-md" style={{ backgroundColor: colors.blue }}>
                        <item.icon className="w-7 h-7" style={{ color: colors.white }} />
                      </div>
                      <div>
                ...
                <div className="bg-gray-100 rounded-2xl p-10 shadow-lg animate-fade-in-right">
                  <h3 className="text-2xl font-bold mb-8" style={{ color: colors.darkGreen }}>Send a Message</h3>
                  <div className="space-y-5">
                    <input
                      type="text"
                      placeholder="Your Name"
                      className="w-full bg-white border border-gray-300 rounded-xl px-6 py-4 focus:outline-none transition-colors focus:border-blue-600"
                    />
                    <input
                      type="email"
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full bg-white border border-gray-300 rounded-xl px-6 py-4 focus:outline-none transition-colors resize-none focus:border-blue-600"
                    ></textarea>
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                      ...
                      className="w-full py-4 rounded-xl font-bold text-base transition-all hover:scale-105 shadow-lg"
                      style={{ backgroundColor: colors.blue, color: colors.white }}
                    >
                      Send Message
                    </button>
